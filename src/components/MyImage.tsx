...
const MyImage = ({className} : {className?: string}) => {
  ...
  return (
     <div className="rounded-full shadow-sm text-neutral-400 dark:text-neutral-600 border border-neutral-600 dark:border-neutral-300 shadow-neutral-400 dark:shadow-black relative">
      <Image
        src={"/images/cv-img.jpg"}
        alt="Hirich oussama's portrait photo"
        height={1406}
        width={1406}
        className={"rounded-full size-16 "+ className}
        priority
      />
      <svg
